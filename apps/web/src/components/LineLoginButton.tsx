...
type LineLoginButtonProps = {
    /** ボタンのラベル文言。例: "LINEでログイン" / "LINEで登録" */
    label: string
}

export function LineLoginButton({ label }: LineLoginButtonProps) {
    // API_URL は "/api" 末尾を含まない base URL から構築する
    const baseUrl = API_URL.replace(/\/api$/, '')
    return (
        <a
            href={`${baseUrl}/api/auth/line`}
